...
import { Utils, CATEGORIAS_TRANSACAO, FORMAS_PAGAMENTO, FINANCEIRO_STATUS, isValidCurrency, FormValidator } from './utils.js'
...
const FinanceiroModule = ({ 
  ...
  // Categorias
  const categorias = CATEGORIAS_TRANSACAO

  // Formas de pagamento
  const formasPagamento = FORMAS_PAGAMENTO

  // Status
  const statusOptions = FINANCEIRO_STATUS
