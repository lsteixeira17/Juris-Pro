...
import { Utils, TIPOS_EVENTO, PRIORIDADES, AGENDA_STATUS, isValidDate, FormValidator } from './utils.js'
...
const AgendaPrazosModule = ({ 
  ...
  // Tipos de eventos
  const tiposEvento = TIPOS_EVENTO

  // Prioridades
  const prioridades = PRIORIDADES

  // Status
  const statusOptions = AGENDA_STATUS
